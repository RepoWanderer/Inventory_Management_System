...
from inventory import add_product, view_products, update_product, delete_product
...
def update_product_list():
    ...
    for product in view_products():
        product_list.insert(tk.END, f"{product[0]} - {product[1]} (Qty: {product[2]}, Price: ${product[3]})")
...
tk.Label(app, text="Quantity").grid(row=1, column=0)
...
# Buttons
tk.Button(app, text="Add Product", command=add_product_gui).grid(row=3, column=0, columnspan=2)

# Product List
product_list = tk.Listbox(app, width=50)
...
class IMS:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | Deepak Sahu")
